...
# Auto Install Tools SK4T3R5 G4N5
# recoded By SK4T3R4
...
sleep 1
echo ""
echo -e $white"[#]> SK4T3R5 Wuzz Here ... "
read enter
exit
}
...
echo -e $white"         # $white copyright : ./SK4T3R5     $white                #"
echo -e $red"         # $white thanks to : TU4N B4DUT - TRIANGLE•Fahri $red      #"
echo -e $white"         *********************************************************"
echo ""
...
sleep 1
echo -e $green" contact WA : 081295091803 "
sleep 1
echo -e $red" fb : https://www.facebook.com/SK4TER5 G4N5 "
sleep 1
echo -e $red" Bye ea :* "
sleep 1
exit
